...
KafkaRPC.prototype.makeRequest = function(topic_name, response_name, content, callback){
    ...
    self.setupResponseQueue(self.producer,topic_name,response_name,function(){
...
KafkaRPC.prototype.setupResponseQueue = function(producer,topic_name,response_name, next){
    ...
    var consumer = self.connection.getConsumer(response_name);
