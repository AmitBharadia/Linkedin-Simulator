    ...
    const { handleSubmit } = this.props;
       return(
           <div>
                ...
                <svg cursor="pointer" onClick={this.openModalEditExperience} viewBox="0 0 24 24" width="24px" height="24px" x="0" y="0" preserveAspectRatio="xMinYMin meet" class="artdeco-icon" focusable="false"><path d="M21,13H13v8H11V13H3V11h8V3h2v8h8v2Z" class="large-icon" style={{"fill": "#006097"}}></path></svg>
