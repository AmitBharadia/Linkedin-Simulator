    ...
    render(){
        ...
        return(
            <div>
                ...
                <h2 style={{"marginLeft":"20px"}}>Please fill the information as asked for in the application.</h2>
                <p style={{"marginLeft":"20px"}}>NOTE: The information would be monitored and kept into database for further screening. Please be assured to have authentic information</p>
                <h2>Company Name</h2>
                <h2>Job ID</h2>
           ...
           <div class="ml-5 mr-5" style={{"width":"20%","marginBottom":"100px"}}>
                            <button
                                    type="submit"
